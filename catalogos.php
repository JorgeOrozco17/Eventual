...
<div class="container mt-10">
    ...
    <div class="row g-5">
        ...
        <div class="col-md-4">
            <div class="card card-flush h-md-100">
                <div class="card-header bg-lila">
                    <h3 class="card-title text-white">Responsables de jurisdicciones</h3>
                </div>
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="mb-5">
                        <span class="menu-icon"><i class="fas fa-address-card fa-3x text-lila mb-4"></i></span>
                        <p class="text-muted">Captura de datos responsables de jurisdicciones</p>
                    </div>
                    <a href="responsables.php" class="btn bg-morado-suave align-self-start">Acceder</a>
                </div>
            </div>
        </div>
