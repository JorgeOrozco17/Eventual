                ...
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    s = {
                        series: [{
                            ...
                            data: [72439191.34,69830841.31,70243270.66,73076999.69,68206247.33,64876087.88,70975636.85,71665852.88,74736639.08,70451299.22,70308054.45,70643192.8,73446320.35]
                        }],
                        chart: {
                            fontFamily: "inherit",
                            type: "area",
                        ...
                        xaxis: {
                            categories: [1,2,3,4,5,6,7,8,9,13,14,15,16],
                            axisBorder: {
                                show: !1
                            },
                            axisTicks: {
...
var KTChartsWidget38_ = function() {
    var e = {
            self: null,
            rendered: !1
        },
        t = function() {
            var t = document.getElementById("kt_charts_widget_38_chart_");
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-gray-900"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = {
                        series: [{
                            name: "Personal",
                            data: [2884,1168,701,663,656,638,619,613,437,129,53,45,43,16,8,4,4,2]
                        }],
                        chart: {
                            fontFamily: "inherit",
                            type: "bar",
...
"undefined" != typeof module && (module.exports = KTChartsWidget38_), KTUtil.onDOMContentLoaded((function() {
    KTChartsWidget38_.init()
}));
